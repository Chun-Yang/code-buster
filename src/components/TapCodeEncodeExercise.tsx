...
export default function TapCodeEncodeExercise({
  expectedLetters,
  inputs,
  errors,
  focusedIndex,
  ...
  function handleInput(index: number, value: string) {
    ...
    setShowHelp(false)
    const filtered = value.replace(/[^1-5]/g, '')
  ...
  function handleTapButton(char: string) {
    if (feedback !== null) return
    setShowHelp(false)
  ...
  return (
    <>
      ...
      <div className="tapcode-buttons">
        <button onClick={() => handleTapButton('1')}>1</button>
        <button onClick={() => handleTapButton('2')}>2</button>
        <button onClick={() => handleTapButton('3')}>3</button>
        <button onClick={() => handleTapButton('4')}>4</button>
        <button onClick={() => handleTapButton('5')}>5</button>
        <button onClick={handleTapBackspace}>DEL</button>
      </div>
    </>
  )
}
